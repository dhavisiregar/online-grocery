...
export default function RegisterPage() {
    ...
    return (
      <AuthCard title="Cek email Anda" subtitle="Registrasi berhasil">
        <p className="text-sm text-foreground/70">
          Kami telah mengirimkan tautan verifikasi ke <strong>{email}</strong>. Tautan berlaku
          selama 1 jam dan digunakan sekaligus untuk membuat password akun Anda.
        </p>
        <Link href="/login" className="mt-4 inline-block text-sm text-brand-dark hover:underline">
  ...
  return (
    <AuthCard title="Buat Akun" subtitle="Daftar untuk mulai berbelanja di FreshMart">
